# [midearth][]
Middle communication between OSC clients and the actual chip. This would run
initially over bluetooth, and then eventually on a base station.
...
[midearth]: https://github.com/thealexgraham/midearth
